import { MousePointer2, Square, Circle, Pentagon, Pencil, CircleDot, RectangleHorizontal, createLucideIcon, type LucideIcon } from 'lucide-react'
...
export type SketchTool = 'select' | 'rectangle' | 'ellipse' | 'polygon' | 'freehand' | 'circle-hole' | 'slot' | 'insert-slot'
